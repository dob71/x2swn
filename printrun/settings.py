...
class Settings(object):
    ...
    def __init__(self, root):
        ...
        self._add(StringSetting("bedtemp_list", "", _("Bed temperatures list"), _("Comma separated bed temp list in C, format <material>:<temp>,..."), "Printer"))
        self._add(StringSetting("temperature_list", "", _("Extruder temperatures list"), _("Comma separated extruder temp list in C, format <material>:<temp>,..."), "Printer"))
        ...
        self._add(HiddenSetting("monitor", True))
